...
**Finance Professional turned AI Builder** | London, UK
...
- Publish open-source libraries for the UK accounting ecosystem

## Featured Projects

| Project | Description | Tech |
|---------|-------------|------|
| [uk-chart-of-accounts](https://pypi.org/project/uk-chart-of-accounts/) | Machine-readable UK Chart of Accounts — 166 nominal codes with VAT treatments, HMRC box mappings, and LLM prompt export. Published on PyPI. | Python, pure stdlib |
...
| Gemini 3 Hackathon (34K participants) | Sterling | Did not place |
